 ...
 * 13/08/2018
 * Tag:
 * Description: https://www.hackerrank.com/challenges/java-static-initializer-block/problem
 * <p>
 * Static initialization blocks are executed when the class is loaded, and you can initialize static variables in those
 * blocks.
 * It's time to test.test your knowledge of Static initialization blocks. You can read about it here.
 ...
 * <p>
 * Input Format
 * There are two lines of input. The first line contains : the breadth of the parallelogram. The next line contains :
